      ...
      const response = await (async () => {
        if (isExtensionServiceInitiationMessage(msg)) {
          try {
            ...
            // const serviceIndex = window.fcl_extensions.findIndex(
            //   ex => ex.endpoint === ENDPOINT
            // )
            // window.fcl_extensions[serviceIndex] = {
            //   ...window.fcl_extensions[serviceIndex],
            // }
          ...
          console.log("proxy.extensionServiceInitiationMessage(msg)", msg)
          return "proxy.extensionServiceInitiationMessage(msg)"
        } else if (isMessage(msg) && msg.type === "FCL:VIEW:READY:RESPONSE") {
          console.log("isConnectorWindowOpen()")
          console.log("proxy.message(msg)", msg)
          return "isConnectorWindowOpen()" ? "proxy.message(msg)" : null
        }
        return null
      })()
      if (response != null) {

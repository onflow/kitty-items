...
var FlowService = /** @class */ (function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                sign = this.signWithKey;
                                pk = this.minterPrivateKeyHex;
                                return [2 /*return*/, __assign(__assign({}, account), { tempId: user.address + "-" + key.index, addr: fcl.sansPrefix(user.address), keyId: Number(key.index), signingFunction: function (signable) {
                                            return {
    ...
    FlowService.prototype.getLatestBlockHeight = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fcl.send([fcl.getBlock(true)])];
                    case 1:
                        block = _a.sent();
                        return [4 /*yield*/, fcl.decode(block)];
                    case 2:
                        decoded = _a.sent();

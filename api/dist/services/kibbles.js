...
var KibblesService = /** @class */ (function () {
    function KibblesService(flowService, fungibleTokenAddress, kibbleAddress) {
        var _this = this;
        ...
        this.mint = function (recipient, amount) { return __awaiter(_this, void 0, void 0, function () {
            var authorization, transaction;
            return __generator(this, function (_a) {
                authorization = this.flowService.authorizeMinter();
                transaction = fs
        ...
        this.burn = function (amount) { return __awaiter(_this, void 0, void 0, function () {
            var authorization, transaction;
            return __generator(this, function (_a) {
                authorization = this.flowService.authorizeMinter();
                transaction = fs
        ...
        this.transfer = function (recipient, amount) { return __awaiter(_this, void 0, void 0, function () {
            var authorization, transaction;
            return __generator(this, function (_a) {
                authorization = this.flowService.authorizeMinter();
                transaction = fs
        ...
        this.getBalance = function (account) { return __awaiter(_this, void 0, void 0, function () {
            var script;
            return __generator(this, function (_a) {
                script = fs

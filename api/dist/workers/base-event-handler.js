...
var sdk_send_1 = require("@onflow/sdk-send");
var sdk_build_get_events_1 = require("@onflow/sdk-build-get-events");
...
var BaseEventHandler = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        cursors = this.eventNames.map(function (eventName) {
                            var cursor = _this.blockCursorService.findOrCreateLatestBlockCursor(latestBlockHeight, eventName);
                                            ...
                                            poll = function () { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_b) {
                                                    switch (_b.label) {
                                                        case 0:
                                                            _b.trys.push([0, 2, , 3]);
                                                            return [4 /*yield*/, this.getBlockRange(blockCursor)];
                                                        case 1:
                                                        ...
                                                        case 2:
                                                            ...
                                                            return [3 /*break*/, 3];
                                                        case 3:
                                                            if (!(fromBlock <= toBlock)) return [3 /*break*/, 9];
                                                            _b.label = 4;
                                                        case 4:
                                                            _b.trys.push([4, 8, , 9]);
                                                            return [4 /*yield*/, sdk_send_1.send([sdk_build_get_events_1.getEvents(eventName, fromBlock, toBlock)])];
                                                        case 5:
                                                            result = _b.sent();
    ...
    BaseEventHandler.prototype.getBlockRange = function (currentBlockCursor) {
        return __awaiter(this, void 0, void 0, function () {
            var latestBlockHeight, fromBlock, toBlock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.flowService.getLatestBlockHeight()];
                    case 1:
                        latestBlockHeight = (_a.sent()) - this.latestBlockOffset;
                        fromBlock = currentBlockCursor.currentBlockHeight + 1;
                        toBlock = currentBlockCursor.currentBlockHeight + this.stepSize;
                        // Don't look ahead to unsealed blocks
                        if (toBlock > latestBlockHeight) {
                            toBlock = latestBlockHeight;
                        }
                        console.log("fromBlock=" + fromBlock + " toBlock=" + toBlock + " latestBlock=" + latestBlockHeight);
                        return [2 /*return*/, { fromBlock: fromBlock, toBlock: toBlock }];
                }
            });
        });
    };
